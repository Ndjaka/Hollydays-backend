...
public class SwaggerConfiguration {
    ...
    public static final Contact DEFAULT_CONTACT = new Contact("Full name", "website", "test@gmail.com");
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(DEFAULT_API_INFO).produces(DEFAULT_PRODUCES_AND_CONSUMES)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.ozone.hollidays.controllers"))
                .build()
                ;
    }
